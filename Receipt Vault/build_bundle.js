/**
 * ReceiptVault - Standalone Bundle Builder
 * Compiles all modular JavaScript files into a single standalone bundle.js
 * allowing ReceiptVault to run seamlessly offline and via direct file:/// double-click.
 */
...
const filesToBundle = [
  ...
  'js/engine/duplicate.js',
  'js/engine/charts.js',
  'js/core/db.js',
  'js/editor/document-viewer.js',
  'js/editor/document-library.js',
  'js/editor/dashboard.js',
  'js/editor/upload-modal.js',
  'js/editor/reports.js',
  'js/app.js'
];
